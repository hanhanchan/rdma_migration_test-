...
class ArgsParser(object):
    ...
    def parse_args():
        ...
        arg_parser.add_argument('-fs', '--file_size', type=int, default=4096,
                                help='equals to number of jobs. (4096, 8192)')
        arg_parser.add_argument('-tm', '--test_mode', type=str, default=write,
                        help='read or write')
        arg_parser.add_argument('-px', '--is_proxy', type=bool, default=True,
        help='is mountpoint or not')
