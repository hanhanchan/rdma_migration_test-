...
const ib_opcode_t UC_RDMA_WRITE_FIRST = 38;
const ib_opcode_t UC_RDMA_WRITE_MIDDLE = 39;
const ib_opcode_t UC_RDMA_WRITE_LAST = 41;
const ib_opcode_t UC_SEND_ONLY=36;
